...
<head>
    ...
    <title>Agregar Nueva Skin - Panel Admin</title>
    <style>
        body {
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-center mb-0">➕ Agregar Nueva Skin</h2>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('skins.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" required 
                                           value="{{ old('nombre') }}" placeholder="Ej: Peely, Midas, etc.">
                                    @error('nombre')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="rareza" name="rareza" required>
                                        ...
                                        <option value="Común" {{ old('rareza') == 'Común' ? 'selected' : '' }}>Común</option>
                                        <option value="Raro" {{ old('rareza') == 'Raro' ? 'selected' : '' }}>Raro</option>
                                        <option value="Épico" {{ old('rareza') == 'Épico' ? 'selected' : '' }}>Épico</option>
                                        <option value="Legendaria" {{ old('rareza') == 'Legendaria' ? 'selected' : '' }}>Legendaria</option>
                                    </select>
                                    @error('rareza')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="descripcion" name="descripcion" rows="3" required 
                                          placeholder="Descripción detallada de la skin">{{ old('descripcion') }}</textarea>
                                @error('descripcion')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="temporada" name="temporada" required 
                                           value="{{ old('temporada') }}" placeholder="Ej: Temporada 2, Capítulo 3, etc.">
                                    @error('temporada')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="imagen" name="imagen" required 
                                           value="{{ old('imagen') }}" placeholder="Ej: assets/img/skin-nombre.webp">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="tipo" name="tipo" required>
                                        ...
                                        <option value="skin" {{ old('tipo') == 'skin' ? 'selected' : '' }}>Skin Normal</option>
                                        <option value="los_siete" {{ old('tipo') == 'los_siete' ? 'selected' : '' }}>Los Siete</option>
                                    </select>
                                    @error('tipo')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <button type="submit" class="btn btn-primary">💾 Guardar Skin</button>
                            </div>
                        </form>
                    </div>
                </div>
